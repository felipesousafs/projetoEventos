...
class ResponsiblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsible" do
    assert_difference('Responsible.count') do
      post responsibles_url, params: { responsible: { description: @responsible.description, event_item_id: @responsible.event_item_id, name: @responsible.name, responsibility_type_id: @responsible.responsibility_type_id } }
    end
  ...
  test "should update responsible" do
    patch responsible_url(@responsible), params: { responsible: { description: @responsible.description, event_item_id: @responsible.event_item_id, name: @responsible.name, responsibility_type_id: @responsible.responsibility_type_id } }
