...
class InscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inscription" do
    assert_difference('Inscription.count') do
      post inscriptions_url, params: { inscription: { coupom_id: @inscription.coupom_id, event_id: @inscription.event_id, paid: @inscription.paid, paid_at: @inscription.paid_at, user_id: @inscription.user_id } }
    end
  ...
  test "should update inscription" do
    patch inscription_url(@inscription), params: { inscription: { coupom_id: @inscription.coupom_id, event_id: @inscription.event_id, paid: @inscription.paid, paid_at: @inscription.paid_at, user_id: @inscription.user_id } }
